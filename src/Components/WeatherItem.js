...
const WeatherItem = (props) => {
  return (
    <div
      ...
      className="border border-gray-200 w-fit rounded-2xl flex flex-row p-6  justify-center align-center gap-8 items-center transition-all duration-300 cursor-pointer hover:shadow-lg "
    >
